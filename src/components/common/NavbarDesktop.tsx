...
const NavbarDesktop = () => {
  return (
    <ul className="*:hover:shadow-custom hidden justify-evenly space-x-10 duration-200 *:flex *:rounded-md *:px-3 *:py-2 *:transition-all *:hover:scale-110 *:hover:bg-emerald-400 *:hover:text-slate-800 md:flex [&_div]:cursor-pointer">
      <NavLink to="/">
